...
<div class="row justify-content-center">
  ...
  <a class="dropshadow" href="https://www.nlrcares.org/staff/stats"><img class="img-thumbnail rounded hvr-grow" src="images/stats_icon.png" alt=""/></a> </div>
    <div class="col-lg-3">
   <a class="dropshadow" href="https://www.nlrcares.org/staff/view"><img class="img-thumbnail rounded hvr-grow" src="images/view_icon.png" alt=""/></a> </div>
    
    <div class="col col-lg-3">
     <a class="dropshadow" href="https://www.nlrcares.org/staff/new"><img class="img-thumbnail rounded hvr-grow" src="images/new_icon.png" alt=""/></a> </div>
	<div class="col col-lg-3">
     <a class="dropshadow" href="https://www.nlrcares.org/staff/survey"><img class="img-thumbnail rounded hvr-grow" src="images/survey.png" alt=""/></a> </div>
    </div>
	</div>
	</body>
